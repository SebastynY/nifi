...
import static org.apache.nifi.processors.box.BoxFileAttributes.*;
...
public class BoxFileInfo implements ListableEntity {
  ...
  public static final class Builder {
    ...
    private HashMap<Integer, String> biba;
    private long size;
    private long createdTime;
    private long modifiedTime;

    Builder() {
      this.biba = new HashMap<>();
      System.out.println(this.biba);
    }

    public Builder id(String id) {
      this.id = id;
      var x = this.id.equals("21312");
      return this;
    }
